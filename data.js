...
window.LIGA = {
  ...
  projetos: [
    ...
    /* ---- Histórico (migrado do site antigo da Liga) ---- */
    { ano: 2023, status: "realizado", titulo: "Copa Vila Velha de Futsal 2023",
      modalidade: "Futsal", local: "Ginásio do Tartarugão, Coqueiral de Itaparica",
      resumo: "Competição de futsal nas categorias infantil e adulto feminino, aberta em 16 de novembro com Nacional x Everest. Semifinais e decisões disputadas na Arena Tartarugão.",
      foto: "" },
    { ano: 2023, status: "realizado", titulo: "Copa Vila Velha de Futebol Infantil",
      modalidade: "Futebol", local: "Vila Velha (5 regiões administrativas)",
      resumo: "Torneio para as categorias sub-11, sub-13 e sub-15, com equipes de bairros de todo o município. Abertura no Campo do Tupy, com festa e muitos gols; campeões Solvive, Tupy e Alvoradinha.",
      foto: "" },
    { ano: 2023, status: "realizado", titulo: "Copa Vila Velha de Futebol Amador",
      modalidade: "Futebol", local: "Vila Velha",
      resumo: "Boi de Raça é o campeão: empate em 1 a 1 com o Botafogo no tempo normal e vitória nos pênaltis por 5 a 3 na grande final.",
      foto: "assets/projetos/boi-de-raca-campeao.jpg" },
    { ano: 2023, status: "realizado", titulo: "Copa Municipal de Vila Velha — Viva Várzea",
      modalidade: "Futebol", local: "Vila Velha",
      resumo: "Campeonato municipal de futebol da várzea, com final entre Explosão e Vila Nova.",
      foto: "" },
    { ano: 2022, status: "realizado", titulo: "Campeonato Estadual de Futebol Society — CAAES",
      modalidade: "Futebol Society", local: "Espírito Santo",
      resumo: "Campeonato da Advocacia Capixaba nas categorias masculina e feminina, com mais de 20 equipes inscritas (6 times femininos), organizado em parceria com a CAAES.",
      foto: "" },
    { ano: 2022, status: "realizado", titulo: "Copa Canela Verde",
      modalidade: "Futebol", local: "Vila Velha",
      resumo: "64 times de 18 bairros e cerca de 100 jogos em menos de 60 dias. O Vila Nova, de Vale Encantado, ficou com o título.",
      foto: "assets/projetos/canela-verde-jogo.jpg" },
    { ano: null, status: "realizado", titulo: "1ª Copa CAAES/OAB-ES de Futebol de Campo",
      modalidade: "Futebol", local: "Espírito Santo",
      resumo: "Primeira edição da copa da advocacia capixaba, em parceria com a CAAES e a OAB-ES. O Resenha FC levou a melhor na decisão.",
      foto: "" }
  ]
};
